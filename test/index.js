var radioactiveDecay = require('../build/build.js'),
...
describe('radioactive decay', function () {
    ...
    describe('decay profile', function () {
        ...
        it('has simple exponential decay for each single isotope', function () {
            ...
            _.each(_.keys(radioactiveDecay.isotopeData), function (isotopeName) {
                ...
                var halflife = radioactiveDecay.isotopeData[isotopeName].halflife;
